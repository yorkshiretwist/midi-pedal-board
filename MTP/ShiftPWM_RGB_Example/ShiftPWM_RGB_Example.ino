...
int numRegisters = 1;
int numRGBleds = 1; //numRegisters*8/3;
...
{    
  ...
  ShiftPWM.SetOne(0,50);
  delay(500);
  ShiftPWM.SetOne(0,0);
  delay(500);

  ShiftPWM.SetOne(1,50);
  delay(500);
  ShiftPWM.SetOne(1,0);
  delay(500);

  ShiftPWM.SetOne(2,50);
  delay(500);
  ShiftPWM.SetOne(2,0);
  delay(500);

  ShiftPWM.SetOne(3,50);
  delay(500);
  ShiftPWM.SetOne(3,0);
  delay(500);

  ShiftPWM.SetOne(4,50);
  delay(500);
  ShiftPWM.SetOne(4,0);
  delay(500);

  ShiftPWM.SetOne(5,50);
  delay(500);
  ShiftPWM.SetOne(5,0);
  delay(500);
